...
subfinder -silent -all -dL domains.txt > 1-passive-sub/1sub.txt   #can use -all flag, use all source enum
...
# puredns resolve -l 1200 -t 50 1-passive-sub/alterx-all-passive.txt -r ~/qed_fuzz/resolvers/resolvers-trusted.txt -w 1-passive-sub/puredns-alterx-all-passive.txt --wildcard-batch 1000000 #-q
...
# puredns bruteforce -l 1200 -t 50 ~/qed_fuzz/best-dns-wordlist.txt -d domains.txt -r ~/qed_fuzz/resolvers/resolvers-trusted.txt -w 2-active-sub/bruteforce-dns-sub.txt --wildcard-batch 1000000 #-q
...
# puredns resolve -l 1200 -t 50 2-active-sub/alterx-all-active.txt -r ~/qed_fuzz/resolvers/resolvers-trusted.txt -w 2-active-sub/puredns-alterx-all-active.txt --wildcard-batch 1000000 -q
...
# httpx -l most-all-subdomains.txt -sc -cl -title -td -nc -silent -rl 120 -t 30 -o 3-live-sub/live-most-all-subdomains.txt 1>/dev/null
# printf "${purple}Probe live subdomsins completed!...${nc}\n\n"

# # classify
# printf "${blue}classify...${nc}\n"
# grep 200 3-live-sub/live-most-all-subdomains.txt > 3-live-sub/200-sub.txt
# grep -E "301|302|304" 3-live-sub/live-most-all-subdomains.txt > 3-live-sub/3begin-sub.txt
# grep -E "403|401|400" 3-live-sub/live-most-all-subdomains.txt > 3-live-sub/4begin-sub.txt
# grep -E "500|501|502|503|504" 3-live-sub/live-most-all-subdomains.txt > 3-live-sub/5begin-sub.txt
